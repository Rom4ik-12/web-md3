...
# Replace it
new_css = re.sub(r'url\(\'data:image/svg\+xml;base64,[A-Za-z0-9+/=]+\'\)', 
                 f"url('data:image/svg+xml;base64,{b64}')", css)

with open(css_file, 'w') as f:
    f.write(new_css)
print('Successfully extracted 6 paths from index.html and updated CSS!')
